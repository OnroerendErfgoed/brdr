...
def test_metadata():
    ...
    assert (
        ...
        == "POLYGON ((0 1, 0 10, 5 10, 9.500000000000004 1, 9.381966011250102 1, 9.36275129165333 0.8049096779838723, 9.305845543761384 0.6173165676348947, 9.213435623552671 0.4444297669804294, 9.089072792436635 0.2928932188134386, 8.937536244269706 0.1685303876974548, 8.76464944361519 0.0761204674887132, 8.577056333266233 0.0192147195967696, 8.3819660112501 0, 0.9999999999999997 0, 0.8049096779838718 0.0192147195967696, 0.6173165676349087 0.0761204674887139, 0.4444297669803966 0.1685303876974555, 0.2928932188134523 0.2928932188134525, 0.1685303876974549 0.4444297669803975, 0.0761204674887134 0.6173165676349098, 0.0192147195967695 0.8049096779838716, 0 1))"
    )
    assert result.results["theme_id_1"][1]["metadata"] == {
        "id": ANY,  # id is unique for each run
        "type": "sosa:Actuation",
        "reference_geometries": [
            {
                "id": ANY, # id is generated if not provided
                "type": "Polygon",
                "version_date": "",
            }
        ],
        "changes": "geo:hasGeometry",
        "result": "brdrid:geoms/890ea10dfbb6759580b80c790bb053a4ea9a67cbe414c87d8cc4197f7f2db1a4",
        "sosa:hasFeatureOfInterest": {"id": ANY},  # id is generated if not provided
        "procedure": {
