...
- Practical note: reference candidate preselection is buffered around the scoped
  ...
  the aligned result inside the scope.
...
- When `processing_area` is used, preselection runs around the scoped geometry part
  (plus distance buffer), reducing unnecessary reference checks for out-of-scope regions.
