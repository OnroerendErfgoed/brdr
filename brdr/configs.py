...
class ProcessorConfig:
    ...
    max_anchor_distance : float, default 10.0
        Maximum spacing (meters) for periodic anchor points on long, mostly
        straight thematic lines in AnchorGeometryProcessor.
    ...
    max_anchor_distance: float = 10.0
