...
SNAPPING_MAX_SEGMENT_LENGTH = 2  # when real snapping of vertices is used, the input geometry will be split up by default in parts of max X meter
...
ID_THEME_FIELD_NAME = "theme_identifier"
