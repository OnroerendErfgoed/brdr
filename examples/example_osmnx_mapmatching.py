...
nodes = ox.distance.nearest_nodes(G, X=[lon for lat, lon in gps_points], Y=[lat for lat, lon in gps_points])
...
fig, ax = ox.plot_graph_route(G, route, route_linewidth=4, node_size=0, bgcolor='white', show=False, close=False)
